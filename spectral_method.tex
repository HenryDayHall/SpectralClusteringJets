...
% define the corrdinate space in a footnote, should say z is the beam distance, and phi is the angle
% z is the ector along the beam line
% barel angle is not the normal phrase
...
% need to define coordinate system before thsi point to use p_z
...
% make a comment here about this not being an issue
% This is more parmeters than in ... howerver
...
%The standard choice for this process is \(\ktstoppingdeltar{}=0.8\).  << this is nt standard .4 is
...
%
    ...
    %That is, unlike the \antikt{} algorithm, there is flexibility in all parameter choices.
    % don't make comparison to akt - akt isn't used except at some standard values
