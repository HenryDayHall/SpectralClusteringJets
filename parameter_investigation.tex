\section{Two Higgs Doublet Model Parameters}
...
(albeit in a Supersymmetric version of the 2HDM) and more recently implemented in Refs.~\cite{Djouadi:1997yw,Krause:2018wmo} in the 2HDM.
...
LHC searches for the complete channels \(gg,b\bar b\to A\to ZH\) and \(gg, b\bar b\to H\to ZA\) have been carried out at both ATLAS~\cite{Aaboud:2018eoy} and CMS ~\cite{Khachatryan:2016are,Sirunyan:2019wrn},
...
Here, we consider the final state \( l^+l^- b\bar b\) and start from the results of~\cite{Aaboud:2018eoy}
