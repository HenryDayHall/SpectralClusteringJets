...
process dependent adjustment of its parameters, unlike the standard approach which needs adapting the jet cone size to the  kinematics of the events  under study.}
 \end{abstract}
\thispagestyle{empty}
\vfill
\newpage
