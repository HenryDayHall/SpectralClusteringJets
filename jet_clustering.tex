...
We will investigate whether such variable-$R$ jets can improve the ability to observe particular 2HDM-II four \bthing{jet} final state topologies. 
...
To label a jet as a \bthing{jet} Monty Carlo (MC) information is used.
...
Indeed the variable-\(R\) algorithm does produce notably sharper mass peaks,
